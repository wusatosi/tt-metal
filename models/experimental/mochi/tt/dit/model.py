...
class AsymmDiTJoint(LightweightModule):
    ...
    def prepare_rope_features(self, T, H, W):
        ...
        rope_cos_1HND = unsqueeze_to_4d(rope_cos_1HND)
        rope_sin_1HND = unsqueeze_to_4d(rope_sin_1HND)

        tt_rope_cos_1HND = to_tt_tensor(rope_cos_1HND, self.mesh_device, shard_dim=-3)
        tt_rope_sin_1HND = to_tt_tensor(rope_sin_1HND, self.mesh_device, shard_dim=-3)
