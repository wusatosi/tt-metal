...
-   YOLOv8x(640x640 resolution) - **0.7269**
-   YOLOv10x(640x640 resolution) - **0.7754**
...
**_For 640x640,_**<br>
```sh
pytest models/experimental/yolo_evaluation/yolo_common_evaluation.py::test_yolov10[tt_model-device_params0]
```
...
-   YOLOv10x(640x640 resolution) - **killed**
...
**_For 640x640,_**<br>
```sh
pytest models/experimental/yolo_evaluation/yolo_common_evaluation.py::test_yolov10[torch_model-device_params0]
```
