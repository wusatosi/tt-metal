...
class YoloV11:
    ...
    def __call__(self, x):
        ...
        x6 = ttnn.to_layout(x6, layout=ttnn.ROW_MAJOR_LAYOUT, memory_config=x4.memory_config())
        
        x = ttnn.to_memory_config(x, x6.memory_config())
        ...
        if x.is_sharded():
            ...
            x = ttnn.interleaved_to_sharded(x, shardspec)
        x = ttnn.upsample(x, scale_factor=2, memory_config=x.memory_config())  # 14
