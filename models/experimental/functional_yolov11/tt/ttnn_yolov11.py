...
class C3K:
    ...
    def __call__(self, device, x):
        ...
        # print("initial", k2.memory_config(), x2.memory_config())
        ...
        # print("after sahrding", k2.memory_config(), x2.memory_config())
        # k2 = ttnn.to_layout(k2, layout=ttnn.ROW_MAJOR_LAYOUT)
        # x2 = ttnn.to_layout(x2, layout=ttnn.ROW_MAJOR_LAYOUT)
        ...
        # print("after layout, final", k2.memory_config(), x2.memory_config())
