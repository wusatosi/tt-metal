...
import ttnn
import torch
from models.experimental.functional_yolov7.tt.common import Conv
import math
...
class ttnn_SPPCSPC:
    ...
    def __call__(self, x):
        ...
        y1 = ttnn.concat([x1, x1_m1, x1_m2, x1_m3], dim=3, memory_config=ttnn.L1_MEMORY_CONFIG)
        ttnn.deallocate(x1)
...
class ttnn_yolov7:
    ...
    def __call__(self, input_tensor):
        ...
        conv34 = ttnn.concat([conv34, conv32], dim=3, memory_config=ttnn.L1_MEMORY_CONFIG)
        ttnn.deallocate(mp3)
        ...
        conv40 = ttnn.concat([conv40, conv38, conv36, conv35], dim=3, memory_config=ttnn.L1_MEMORY_CONFIG)
