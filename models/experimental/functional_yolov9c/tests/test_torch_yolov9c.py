...
from models.experimental.functional_yolov9c.reference import yolov9
...
try:
    sys.modules["ultralytics"] = yolov9
    sys.modules["ultralytics.nn.tasks"] = yolov9
    sys.modules["ultralytics.nn.modules.conv"] = yolov9
    sys.modules["ultralytics.nn.modules.block"] = yolov9
    sys.modules["ultralytics.nn.modules.head"] = yolov9
...
def test_yolov9(device, use_program_cache, reset_seeds):
    ...
    torch_input = torch.load("models/experimental/functional_yolov9c/input.pt")
    torch_model = attempt_load("yolov9c.pt", map_location="cpu")
    state_dict = torch_model.state_dict()
    torch_model = yolov9.YoloV9()
    print(torch_model)
    ...
    print("Shape of torch output :", torch_output.shape)
