...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        torch_input = x
        print("Shape in bn :", x.shape, " ", self.cv1(x).shape, " ", self.cv2(self.cv1(x)).shape)
...
class RepBottleneck(Bottleneck):
    ...
    def __init__(self, in_channel, out_channel):
        ...
        print("Channel in repbottleneck :", in_channel, " ", out_channel)
...
class C3(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.cv3 = Conv(in_channel // 2, out_channel // 2)  # optional act=FReLU(c2)
...
class RepCSP(C3):
    ...
    def __init__(self, in_channel, out_channel):
        ...
        print("Inside repCSP --", in_channel, " ", out_channel)
...
class Detect(nn.Module):
    def __init__(self, in_channel):  # , out_channel, padding, dilation, groups):
        super().__init__()
