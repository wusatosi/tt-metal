...
def run_conv_with_split(
    ...
    split_input_tensors = ttnn.split(input_tensor, split_factor, 1, memory_config=memory_config)
    ...
    for i in range(split_factor):
        tt_input_tensor = ttnn.permute(split_input_tensors[i], (0, 2, 3, 1), memory_config=memory_config)
        """
        print(
...
def update_params(parameters):
    ...
    # parameters.down_blocks[1]["attn1"]["sharding_strategy"] = "height"
    # parameters.down_blocks[1]["attn2"]["sharding_strategy"] = "height"
    # parameters.down_blocks[2]["attn1"]["sharding_strategy"] = "height"
    # parameters.down_blocks[2]["attn2"]["sharding_strategy"] = "height"
