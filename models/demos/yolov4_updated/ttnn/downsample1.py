...
import torch
import ttnn
from models.demos.yolov4_updated.ttnn.common import Conv
...
class Down1:
    ...
    def __call__(self, input_tensor):
        ...
        # if self.parameters.resolution[0] != 320:   #if uncommented self.conv2 works fine, however ttnn.sharded_to_interleaved takes high kernel duration
