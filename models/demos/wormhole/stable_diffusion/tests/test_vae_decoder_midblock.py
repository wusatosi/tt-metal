...
@pytest.mark.parametrize(
    "input_channels, input_height, input_width, resnet_norm_blocks",
    [
        (512, 64, 64, [(1, 1), (1, 1)]),
    ],
)
def test_upblock(
    ...
    ttnn_model = MidBlock(
        torch_midblock, device, compute_config, input_channels, input_height, input_width, resnet_norm_blocks
    )
