...
def get_ccl_config(mesh_device):
    ...
    return ccl_semaphore_handle, from_remote_semaphore_handles, to_remote_semaphore_handles
...
def run_falcon_demo_kv(
    ...
    ccl_semaphore_handle, from_remote_semaphore_handles, to_remote_semaphore_handles = get_ccl_config(mesh_device)
