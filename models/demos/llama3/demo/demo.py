...
def run_llama3_demo(
    ...
    if model_args.model_name == "Llama3.1-70B" and max_seq_len >= 64 * 1024:
    ...
    if llama_model_name in ["Llama3.1-8B", "Llama3.2-11B"]:
        if tt_device_name == "N150":
            assert (
                max_seq_len <= 16 * 1024
