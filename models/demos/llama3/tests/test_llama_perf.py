...
def test_llama_model_perf(
    ...
    model_args = TtModelArgs(mesh_device, max_batch_size=1, max_seq_len=2048)
...
def run_inference(
    ...
    for i in range(generation_length):
        ...
        tt_out = tt_model(decode_input, current_pos, rot_mat=current_rot_mat, mode="decode", page_table=page_table)
