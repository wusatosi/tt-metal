...
def test_tt_model_accuracy(mesh_device, prefill_len, decode_len, paged_attention, use_program_cache, reset_seeds):
    ...
    model_args = TtModelArgs(mesh_device, max_batch_size=1, max_seq_len=1024)
