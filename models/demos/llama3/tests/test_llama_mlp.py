...
@pytest.mark.parametrize(
    "mesh_device",
    [
        {"N150": (1, 1), "N300": (1, 2), "T3K": (1, 8), "TG": (8, 4), "2xP150": (1, 2), "4xP150": (1, 4)}.get(
...
def test_llama_mlp_inference(seq_len, batch_size, mesh_device, use_program_cache, reset_seeds, ensure_gc):
    ...
    model_args = TtModelArgs(mesh_device, max_batch_size=batch_size, max_seq_len=128, dummy_weights=True)
