...
perf_targets = {
    ...
    "model_tail": {
        "InterleavedToShardedDeviceOperation_0": {
            ...
            "kernel_duration": 22962.0,
            "op_to_op": 0,
            "non-overlapped-dispatch-time": 0,
            "kernel_duration_relative_margin": 0.2,
            "op_to_op_duration_relative_margin": 0.2,
            "dispatch_duration_relative_margin": 0.5,
        },
        ...
        "RMSAllGather_1": {
            "op_name": "RMSAllGather_1",
            "kernel_duration": 4754.1875,
            "op_to_op": 0,
            "non-overlapped-dispatch-time": 0,
            "kernel_duration_relative_margin": 0.2,
            "op_to_op_duration_relative_margin": 0.2,
        ...
        "BinaryDeviceOperation_0": {
            "op_name": "BinaryDeviceOperation_0",
            "kernel_duration": 3229.0,
            "op_to_op": 0,
            "non-overlapped-dispatch-time": 0,
            "kernel_duration_relative_margin": 0.2,
            "op_to_op_duration_relative_margin": 0.2,
...
def process_measurements(df, num_layers):
    raw_dict = df[["OP CODE", "DEVICE KERNEL DURATION [ns]", "OP TO OP LATENCY [ns]"]].to_dict(orient="records")
...
def test_llama_TG_perf_device(
    ...
    avg_kernel_duration_first_layer_compilation, _, _, _, _, _ = process_measurements(df_first_layer_compilation, 1)
    avg_kernel_duration_first_layer_trace, _, _, avg_dispatch_duration_first_layer_trace, _, _ = process_measurements(
