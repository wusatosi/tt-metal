...
class TT_CCL:
    ...
    def tt_line_all_gather(self, input_tensor_mesh, dim, cluster_axis, num_links, memory_config):
    ...
    def tt_line_reduce_scatter(
        self, tensor, memory_config, dim, cluster_axis, num_links=1, math_op=ttnn.ReduceType.Sum
    ):
