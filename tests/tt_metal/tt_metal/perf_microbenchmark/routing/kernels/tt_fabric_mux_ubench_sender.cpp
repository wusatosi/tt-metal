...
void kernel_main() {
    ...
    if constexpr (is_master_sender) {
        ...
        DPRINT << "master, sending mcast" << ENDL();
    ...
    DPRINT << "senders, disconnecting" << ENDL();
