...
int main(int argc, char** argv) {
    ...
    try {
        ...
        switch (source_mem_g) {
            ...
            default: {
                src_mem = "FROM_PCIE";
                vector<tt::umd::CoreCoord> pcie_cores = soc_d.get_cores(CoreType::PCIE, CoordSystem::VIRTUAL);
            ...
            case 1: {
                src_mem = "FROM_DRAM";
                vector<tt::umd::CoreCoord> dram_cores = soc_d.get_cores(CoreType::DRAM, CoordSystem::VIRTUAL);
