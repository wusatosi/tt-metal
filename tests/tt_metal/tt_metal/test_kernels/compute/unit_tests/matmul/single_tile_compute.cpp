...
void MAIN {
    ...
    ckernel::cb_reserve_back(out_cb, num_out_tiles);
    ckernel::acquire_dst();
    ckernel::cb_wait_front(in0_cb, num_in0_tiles);
    ckernel::cb_wait_front(in1_cb, num_in1_tiles);
    matmul_tiles(in0_cb, in1_cb, in0_tile_index, in1_tile_index, out_tile_index, transpose);
    ckernel:: pack_tile(0, out_cb);
    ckernel::cb_pop_front(in0_cb, num_in0_tiles);
    ckernel::cb_pop_front(in1_cb, num_in1_tiles);
    ckernel:: release_dst();
    ckernel::cb_push_back(out_cb, num_out_tiles);
}
}  // namespace NAMESPACE
