...
constexpr bool ENABLE_WORKER = get_compile_time_arg_val(4) == 1;
constexpr bool DISABLE_TRID = get_compile_time_arg_val(5) == 1;

#include "eth_send_recv_write_worker_ubench_common.hpp"

///////////////////////////////////////////////// sender main loop /////////////////////////////////////////////////
FORCE_INLINE void main_sender_loop_uni_dir(
...
FORCE_INLINE void main_loop_bi_dir(
    ...
    while (num_messages_ack < total_msgs) {
        ...
        update_receiver_state<ENABLE_WORKER, DISABLE_TRID>(
...
void kernel_main() {
...

    {
        ...
        main_loop_bi_dir(
            ...
            worker_noc_addr);
#else
        main_sender_loop_uni_dir(
            sender_buffer_slot_addrs, sender_buffer_slot_sync_addrs, full_payload_size, num_messages);
#endif
    }
