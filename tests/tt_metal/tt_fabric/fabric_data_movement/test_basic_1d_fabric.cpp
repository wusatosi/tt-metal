...
//         src_physical_device_id, dst_physical_device_id, 0, sender_program, {sender_logical_core},
//         sender_runtime_args);
...
//     auto src_phys_chip_id = control_plane->get_physical_chip_id_from_mesh_chip_id(std::make_pair(mesh_id.value(),
//     1)); auto left_recv_phys_chip_id =
...
//         ((uint64_t)left_recv_status[TT_FABRIC_WORD_CNT_INDEX + 1] << 32) |
//         left_recv_status[TT_FABRIC_WORD_CNT_INDEX];
//     uint64_t right_recv_bytes =
//         ((uint64_t)right_recv_status[TT_FABRIC_WORD_CNT_INDEX + 1] << 32) |
//         right_recv_status[TT_FABRIC_WORD_CNT_INDEX];
