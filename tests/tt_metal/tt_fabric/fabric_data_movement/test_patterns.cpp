...
TEST_F(FabricFixture, TestAtomicIncRoutingPlane) {
    CoreCoord sender_logical_core = {0, 0};
    CoreCoord receiver_logical_core = {1, 0};
    std::pair<mesh_id_t, chip_id_t> start_mesh_chip_id;
    chip_id_t physical_start_device_id;
    ...
    auto sender_kernel = tt_metal::CreateKernel(
        sender_program,
        "tests/tt_metal/tt_fabric/fabric_data_movement/kernels/fabric_atomic_inc_routing_plane_sender.cpp",
        {sender_logical_core},
        tt_metal::DataMovementConfig{
            .processor = tt_metal::DataMovementProcessor::RISCV_0, .noc = NOC::RISCV_0_default});
...
TEST_F(FabricFixture, TestAyncWriteAtomicIncRoutingPlane) {
    CoreCoord sender_logical_core = {0, 0};
    CoreCoord receiver_logical_core = {1, 0};
    std::pair<mesh_id_t, chip_id_t> start_mesh_chip_id;
    chip_id_t physical_start_device_id;
    ...
    auto sender_kernel = tt_metal::CreateKernel(
        sender_program,
        "tests/tt_metal/tt_fabric/fabric_data_movement/kernels/fabric_async_write_atomic_inc_routing_plane_sender.cpp",
        {sender_logical_core},
        tt_metal::DataMovementConfig{
            .processor = tt_metal::DataMovementProcessor::RISCV_0, .noc = NOC::RISCV_0_default});
...
TEST_F(FabricFixture, TestAsyncWriteMulticastRoutingPlane) {
    CoreCoord sender_logical_core = {0, 0};
    CoreCoord receiver_logical_core = {1, 0};
    std::pair<mesh_id_t, chip_id_t> start_mesh_chip_id;
    chip_id_t physical_start_device_id;
    ...
    uint32_t client_interface_addr = worker_unreserved_base_addr;
    uint32_t packet_header_addr = tt::round_up(
        client_interface_addr + sizeof(fabric_client_interface_t) * num_dirs + sizeof(fabric_client_interface_t) +
            4 * sizeof(fabric_router_l1_config_t),
        l1_alignment);
    uint32_t buffer_data_addr = packet_header_addr + PACKET_HEADER_SIZE_BYTES;
    uint32_t buffer_data_size = tt::constants::TILE_HW * sizeof(uint32_t);
    std::vector<uint32_t> buffer_data(buffer_data_size / sizeof(uint32_t), 0);
    ...
    auto sender_kernel = tt_metal::CreateKernel(
        sender_program,
        "tests/tt_metal/tt_fabric/fabric_data_movement/kernels/fabric_async_write_multicast_routing_plane_sender.cpp",
        {sender_logical_core},
        tt_metal::DataMovementConfig{
            .processor = tt_metal::DataMovementProcessor::RISCV_0, .noc = NOC::RISCV_0_default});
    ...
    std::unordered_map<RoutingDirection, uint32_t> sender_routing_planes;
    for (auto& [routing_direction, end_mesh_chip_ids] : end_mesh_chip_ids_by_dir) {
        uint32_t routing_plane = 0;
        sender_routing_planes.try_emplace(routing_direction, routing_plane);
    }
    std::vector<uint32_t> sender_runtime_args = {
        client_interface_addr,
        sender_gk_interface_addr,
        ...
        sender_routing_planes[RoutingDirection::E]};
    tt_metal::SetRuntimeArgs(sender_program, sender_kernel, sender_logical_core, sender_runtime_args);
...
TEST_F(FabricFixture, TestAsyncWriteMulticastMultidirectionalRoutingPlane) {
    CoreCoord sender_logical_core = {0, 0};
    CoreCoord receiver_logical_core = {1, 0};
    std::pair<mesh_id_t, chip_id_t> start_mesh_chip_id;
    chip_id_t physical_start_device_id;
    ...
    uint32_t client_interface_addr = worker_unreserved_base_addr;
    uint32_t packet_header_addr = tt::round_up(
        client_interface_addr + sizeof(fabric_client_interface_t) * num_dirs + 4 * sizeof(fabric_router_l1_config_t),
        l1_alignment);
    uint32_t buffer_data_addr = packet_header_addr + PACKET_HEADER_SIZE_BYTES;
    uint32_t buffer_data_size = tt::constants::TILE_HW * sizeof(uint32_t);
    std::vector<uint32_t> buffer_data(buffer_data_size / sizeof(uint32_t), 0);
    ...
    auto sender_kernel = tt_metal::CreateKernel(
        ...
        "fabric_async_write_multicast_multidirectional_routing_plane_sender.cpp",
        {sender_logical_core},
        tt_metal::DataMovementConfig{
            .processor = tt_metal::DataMovementProcessor::RISCV_0, .noc = NOC::RISCV_0_default});
    ...
    std::vector<uint32_t> sender_runtime_args = {
        ...
        sender_routing_planes[RoutingDirection::W]
        ...
        // sender_routing_planes[RoutingDirection::N],
        ...
        // sender_routing_planes[RoutingDirection::S]
    };
    tt_metal::SetRuntimeArgs(sender_program, sender_kernel, sender_logical_core, sender_runtime_args);
