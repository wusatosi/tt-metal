...
def run(
    ...
    *,
    ...
    torch_input_tensor_a_int = torch_input_tensor_a.to(torch.int32)
    torch_input_tensor_b_int = torch_input_tensor_b.to(torch.int32)

    golden_function = ttnn.get_golden_function(ttnn.lcm)
    torch_output_tensor = golden_function(torch_input_tensor_a_int, torch_input_tensor_b_int)
    ...
    result = ttnn.lcm(input_tensor_a, input_tensor_b, memory_config=sharded_config)
