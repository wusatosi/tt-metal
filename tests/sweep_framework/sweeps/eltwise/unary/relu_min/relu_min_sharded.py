...
def run(
    ...
    *,
    ...
    golden_function = ttnn.get_golden_function(ttnn.relu_min, lower_limit=lower_limit)
    ...
    output_tensor = ttnn.relu_min(input_tensor_a, lower_linmit, memory_config=sharded_config)
