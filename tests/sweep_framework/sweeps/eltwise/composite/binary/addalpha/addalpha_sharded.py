...
def run(
    ...
    *,
    ...
    torch_op = ttnn.get_golden_function(ttnn.addalpha)
    torch_output_tensor = torch_op(torch_input_tensor_a, torch_input_tensor_b, alpha)
    ...
    output_tensor = ttnn.addalpha(input_tensor_a, input_tensor_b, alpha, memory_config=sharded_config)
