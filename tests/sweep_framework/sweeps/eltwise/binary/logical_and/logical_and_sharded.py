...
parameters = {
    "xfail": {
        "input_spec": list(gen_unary_sharded_spec(4, 4, "ROW_MAJOR", "TENSOR_HW"))
        + list(gen_unary_sharded_spec(4, 4, "COL_MAJOR", "TENSOR_HW"))
        + list(gen_unary_sharded_spec(4, 4, "ROW_MAJOR", "BLOCK"))
        + list(gen_unary_sharded_spec(4, 4, "COL_MAJOR", "BLOCK"))
        + list(gen_unary_sharded_spec(4, 4, "ROW_MAJOR", "HEIGHT"))
        + list(gen_unary_sharded_spec(4, 4, "COL_MAJOR", "HEIGHT"))
        + list(gen_unary_sharded_spec(4, 4, "ROW_MAJOR", "WIDTH"))
        + list(gen_unary_sharded_spec(4, 4, "COL_MAJOR", "WIDTH")),
