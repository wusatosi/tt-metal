...
def run(
    ...
    *,
    ...
    torch_output_tensor = golden_function(
        torch_input_tensor_a, torch_input_tensor_b, activations=None if activations == "None" else activations
    )
    ...
    output_tensor = ttnn.multiply(input_tensor_a, input_tensor_b, activations=activations, memory_config=sharded_config)
