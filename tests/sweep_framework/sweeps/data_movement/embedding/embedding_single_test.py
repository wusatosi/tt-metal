...
@pytest.mark.parametrize(
    "embedding_specs, dtype, indices_layout, weight_layout, output_layout",
    [
        # (
        #     {"weight_shape": [1, 768], "indices_shape": [1, 10]},
        #     ttnn.bfloat16,
...
def test_embedding_single(
    ...
    *,
    ...
    print(
        "weight_shape={}, indices_shape={}, padding_idx ={}, indices_layout={}, weight_layout={}, output_layout={}.llong".format(
            weight_shape, indices_shape, padding_idx, indices_layout, weight_layout, output_layout
        )
    )
    try:
        ...
        # print("weight_shape={}, indices_shape={}, padding_idx ={}, indices_layout={}, weight_layout={}, output_layout={}.llong".format(weight_shape, indices_shape, padding_idx, indices_layout,weight_layout, output_layout))
