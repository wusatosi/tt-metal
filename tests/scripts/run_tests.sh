...
run_pipeline_tests() {
    ...
    # TG pipelines
        ...
        ./tests/ttnn/unit_tests/operations/ccl/perf/run_all_gather_profile.sh -t tg -d
        ./tests/ttnn/unit_tests/operations/ccl/perf/run_reduce_scatter_profile.sh -t tg -d
    # TGG pipelines
