...
@pytest.mark.parametrize(
    ...
    (
        ...
        # UNet
        # kernel 3x3
        (1, 1280, 1280, 32, 32, ttnn.bfloat16, ttnn.bfloat16, 1, (3, 3), (1, 1), (1, 1), (1, 1), False, 64, 1, True, ttnn.MathFidelity.HiFi4, False, False, False, 1, 1, False, False),
        ...
        (1, 1280, 640, 64, 64, ttnn.bfloat16, ttnn.bfloat16, 1, (3, 3), (1, 1), (1, 1), (1, 1), False,  32, 1, True, ttnn.MathFidelity.HiFi4, False, False, False, 1, 1, False, False),
