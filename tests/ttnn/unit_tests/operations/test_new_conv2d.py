...
@pytest.mark.parametrize(
    "batch_size, input_channels, output_channels, input_height, input_width, filter_height, filter_width, stride_h, stride_w, pad_h, pad_w, groups, use_1d_systolic_array, config_override, use_shallow_conv_variant",
    (
        (1, 3, 32, 224, 224, 3, 3, 2, 2, 1, 1, 1, True, None, True),
        (1, 32, 32, 112, 112, 3, 3, 1, 1, 1, 1, 32, True, None, False),
        (1, 32, 16, 112, 112, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 16, 96, 112, 112, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 96, 96, 112, 112, 3, 3, 2, 2, 1, 1, 96, True, None, True),
        (1, 96, 24, 56, 56, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 24, 144, 56, 56, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 144, 144, 56, 56, 3, 3, 1, 1, 1, 1, 144, True, None, False),
        (1, 144, 24, 56, 56, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 144, 144, 56, 56, 3, 3, 2, 2, 1, 1, 144, True, None, False),
        (1, 144, 32, 28, 28, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 32, 192, 28, 28, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 192, 192, 28, 28, 3, 3, 1, 1, 1, 1, 192, True, None, False),
        (1, 192, 32, 28, 28, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 192, 192, 28, 28, 3, 3, 2, 2, 1, 1, 192, True, None, False),
        (1, 192, 64, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 64, 384, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 384, 384, 28, 28, 3, 3, 1, 1, 1, 1, 384, True, None, False),
        (1, 384, 64, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 64, 384, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 384, 96, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 96, 576, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 576, 576, 14, 14, 3, 3, 1, 1, 1, 1, 576, False, None, False),
        (1, 576, 96, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 576, 96, 14, 14, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 576, 576, 14, 14, 3, 3, 2, 2, 1, 1, 576, False, None, False),
        (1, 576, 160, 7, 7, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 160, 960, 7, 7, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 960, 960, 7, 7, 3, 3, 1, 1, 1, 1, 960, False, None, False),
        (1, 960, 160, 7, 7, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 960, 320, 7, 7, 1, 1, 1, 1, 0, 0, 1, True, None, False),
