...
@pytest.mark.parametrize(
    ...
    (
        (1, 3, 32, 256, 256, 3, 3, 2, 2, 0, 0, 1, True, None, True),
        (1, 32, 32, 128, 128, 3, 3, 1, 1, 0, 0, 32, True, None, False),
        ...
        (1, 96, 96, 128, 128, 3, 3, 2, 2, 0, 0, 96, True, None, False),
        ...
        (1, 144, 144, 64, 64, 3, 3, 1, 1, 0, 0, 144, True, None, False),
        ...
        (1, 144, 144, 64, 64, 5, 5, 2, 2, 0, 0, 144, True, None, False),
        (1, 144, 40, 32, 32, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 40, 240, 32, 32, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        ...
        (1, 240, 40, 32, 32, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 240, 240, 32, 32, 3, 3, 2, 2, 0, 0, 240, True, None, False),
        (1, 240, 40, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 40, 480, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 480, 480, 16, 16, 3, 3, 1, 1, 0, 0, 480, True, None, False), #weights_dtype= ttnn.bfloat8_b
        (1, 480, 20, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
         (1, 20, 480, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 480, 80, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 80, 480, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 480, 480, 16, 16, 5, 5, 1, 1, 0, 0, 480, False, None, False),
        (1, 112, 672, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 672, 672, 16, 16, 5, 5, 1, 1, 0, 0, 672, False, None, False),
        (1, 672, 28, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 28, 672, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 672, 112, 16, 16, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 672, 672, 16, 16, 5, 5, 2, 2, 0, 0, 672, False, None, False),
        (1, 672, 192, 8, 8, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 192, 1152, 8, 8, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        # (1, 1152, 1152, 8, 8, 5, 5, 1, 1, 0, 0, 1152, False, None, False), #fAILED
        (1, 1152, 48, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 48, 1152, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 1152, 192, 8, 8, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 192,1152, 8, 8, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 1152, 48, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 1152,192, 8, 8, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 1152, 1152, 8, 8, 3, 3, 1, 1, 0, 0, 1152, False, None, False),
        (1, 1152, 320, 1, 1, 1, 1, 1, 1, 0, 0, 1, True, None, False),
