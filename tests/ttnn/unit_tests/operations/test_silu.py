...
@pytest.mark.parametrize(
    "batch_size, input_channels, input_height, input_width, ncores, grid_size, shard_strategy, shard_orientation",
    (
        (1, 512, 64, 64, 64, (7, 8), ttnn.ShardStrategy.HEIGHT, ttnn.ShardOrientation.ROW_MAJOR),  # Passed
        (1, 512, 128, 128, 64, (7, 8), ttnn.ShardStrategy.HEIGHT, ttnn.ShardOrientation.ROW_MAJOR),  # Passed
