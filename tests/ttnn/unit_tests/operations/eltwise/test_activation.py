...
def run_activation_unary_test_4d(device, n, c, h, w, ttnn_function, pcc=0.99):
    torch.manual_seed(0)
...
def test_swin(device, n, c, h, w):
    run_activation_unary_test_4d(device, n, c, h, w, ttnn.gelu)
