...
@pytest.mark.parametrize("device_params", [{"l1_small_size": 16384}], indirect=True)
@pytest.mark.parametrize(
    "batch_size, output_channels,input_channels, input_height, input_width, filter_height, filter_width, stride_h, stride_w, pad_h, pad_w, activation, shard_layout, config_override, use_shallow_conv_variant, auto_shard",
    (
        (1, 80, 3, 640, 640, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 80, 320, 320, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 160, 160, 160, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 320, 160, 160, 160, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 320, 320, 80, 80, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 640, 320, 80, 80, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 640, 640, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 640, 640, 40, 40, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 640, 640, 20, 20, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 320, 640, 20, 20, 1, 1, 1, 1, 0, 0, "relu", HS, None, False, False), # PASSED with HS
        (1, 640, 1280, 20, 20, 1, 1, 1, 1, 0, 0, "relu", WS, None, False, False), # PASSED with WS
        (1, 320, 960, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 320, 320, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 320, 40, 40, 1, 1, 1, 1, 0, 0, "relu", HS, None, False, False), # PASSED with HS
        (1, 160, 480, 80, 80, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 160, 80, 80, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 160, 80, 80, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 320, 320, 40, 40, 3, 3, 2, 2, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 160, 80, 80, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 80, 80, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 80, 80, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
        (1, 80, 160, 80, 80, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
        (1, 64, 320, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 40, 40, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
        (1, 160, 320, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 160, 40, 40, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 80, 160, 40, 40, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
        (1, 64, 640, 20, 20, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 20, 20, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 64, 64, 20, 20, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
        (1, 160, 640, 20, 20, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 160, 160, 20, 20, 3, 3, 1, 1, 1, 1, "relu", None, None, False, True), # PASSED
        (1, 80, 160, 20, 20, 1, 1, 1, 1, 0, 0, "", None, None, False, True), # PASSED
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
