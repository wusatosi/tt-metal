...
def run_allgather_silu_with_trace(
    mesh_device,
    all_gather_topology,
    input_tensor_mesh,
    buffer_tensor,
...
def run_all_gather_silu_impl(
    ...
    for i in range(num_iters):
        ...
        print("before creating intermediate tensor")
    ...
    if trace_mode:
        print("before calling function with trace")
        tt_out_tensor = run_allgather_silu_with_trace(
            mesh_device,
            all_gather_topology,
