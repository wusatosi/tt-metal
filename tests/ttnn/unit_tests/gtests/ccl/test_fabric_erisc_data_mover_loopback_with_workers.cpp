...
//         ShardSpec(
//             CoreRangeSet{
//                 std::set<CoreRange>{CoreRange{CoreCoord{0, 0}, CoreCoord{in_shard_grid_x - 1, in_shard_grid_y -
//                 1}}}},
...
//         ShardSpec(
//             CoreRangeSet{
//                 std::set<CoreRange>{CoreRange{CoreCoord{0, 0}, CoreCoord{out_shard_grid_x - 1, out_shard_grid_y -
//                 1}}}},
//             {tensor_shape[0] * tensor_shape[1] * tensor_shape[2],
...
//             .to_layout(layout);
//     Tensor output_tensor0 = ttnn::experimental::view(ttnn::ones(tensor_shape, DataType::UINT32, layout),
//     tensor_shape); Tensor output_tensor1 = ttnn::experimental::view(ttnn::ones(tensor_shape, DataType::UINT32,
//     layout), tensor_shape);
...
//     ttnn::ccl::cmd::CclCommandDestArgs dest_args = ttnn::ccl::cmd::UnicastCommandDestArgs{distance_dest_device,
//     true}; auto pass = TestMultiInputReaderKernel(
//         num_devices,
//         input_tensor0,
//         in0_memory_config,
//         input_tensor1,
...
//         auto t =
//             ttnn::experimental::view(ttnn::arange(0, num_elems, 1, DataType::BFLOAT16),
