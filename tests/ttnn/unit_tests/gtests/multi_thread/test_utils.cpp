...
std::tuple<GlobalSemaphore, GlobalSemaphore, GlobalSemaphore> create_global_semaphores(
    std::shared_ptr<tt::tt_metal::distributed::MeshDevice>& mesh_device, IDevice* device) {
