...
def test_yolov7(device, reset_seeds):
    ...
    ttnn_input = ttnn.from_torch(
        ...
        # input_tensor, dtype=ttnn.bfloat8_b, layout=ttnn.TILE_LAYOUT
    ...
    assert_with_pcc(torch_output_tensor[0], output, pcc=0.99)  # PCC = 0.9788256548589473
