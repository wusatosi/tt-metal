...
fvc_consumer_state_t fvc_consumer_state __attribute__((aligned(16), section(".fabric_router_data")));                // replicate for each fvc
#ifdef FVCC_SUPPORT
fvcc_inbound_state_t fvcc_inbound_state __attribute__((aligned(16), section(".fabric_router_data")));    // inbound fabric virtual control channel
fvcc_outbound_state_t fvcc_outbound_state __attribute__((aligned(16), section(".fabric_router_data")));  // outbound fabric virtual control channel
#endif
volatile local_pull_request_t local_pull_request_temp __attribute__((aligned(16), section(".fabric_router_data")));  // replicate for each fvc
