...
void MAIN {
    ...
    ckernel::cb_wait_front(tt::CBIndex::c_0, Wt * Ht);
    ckernel::cb_reserve_back(tt::CBIndex::c_16, Wt * Ht);
    uint32_t b_offset = 0;
    ...
    ckernel::cb_pop_front(tt::CBIndex::c_0, Wt * Ht);
    ckernel::cb_push_back(tt::CBIndex::c_16, Wt * Ht);
}
}  // namespace NAMESPACE
