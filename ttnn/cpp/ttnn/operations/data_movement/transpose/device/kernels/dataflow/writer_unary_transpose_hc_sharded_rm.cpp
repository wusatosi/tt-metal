...
void kernel_main() {
    ...
    const tt_l1_ptr uint32_t* read_stick_offset = (const tt_l1_ptr uint32_t*)(get_arg_addr(7));
    const tt_l1_ptr uint32_t* noc_coord_x = (const tt_l1_ptr uint32_t*)(get_arg_addr(7 + num_cores_read));
    const tt_l1_ptr uint32_t* noc_coord_y = (const tt_l1_ptr uint32_t*)(get_arg_addr(7 + num_cores_read * 2));
