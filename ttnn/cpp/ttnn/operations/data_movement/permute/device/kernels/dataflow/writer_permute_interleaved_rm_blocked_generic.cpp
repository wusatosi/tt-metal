...
void kernel_main() {
    ...
    constexpr uint32_t output_cb_page_size = get_compile_time_arg_val(3);
    constexpr uint32_t num_rows = get_compile_time_arg_val(4);

    constexpr uint32_t X = get_compile_time_arg_val(5);
    constexpr uint32_t X_stride = get_compile_time_arg_val(6);
    constexpr uint32_t x_dim = get_compile_time_arg_val(7);

    constexpr uint32_t W_stride = get_compile_time_arg_val(8);
    constexpr uint32_t input_cb_page_size = get_compile_time_arg_val(9);
    constexpr uint32_t element_size = get_compile_time_arg_val(10);

    constexpr uint32_t num_blocks_total = get_compile_time_arg_val(11);
    constexpr uint32_t x_blocks = get_compile_time_arg_val(12);
    constexpr uint32_t w_blocks = get_compile_time_arg_val(13);
    constexpr uint32_t x_block_size = get_compile_time_arg_val(14);
    constexpr uint32_t w_block_size = get_compile_time_arg_val(15);
    constexpr uint32_t W = get_compile_time_arg_val(16);
    constexpr uint32_t output_tensor_page_size = get_compile_time_arg_val(17);
