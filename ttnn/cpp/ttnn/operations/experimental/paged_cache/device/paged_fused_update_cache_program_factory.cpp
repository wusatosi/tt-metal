...
operation::ProgramWithCallbacks paged_fused_update_cache_multi_core(
    ...
    const tt::CBIndex intermed0_cb_index = CBIndex::c_6;
    const tt::CBIndex intermed1_cb_index = CBIndex::c_7;
    const tt::CBIndex intermed2_cb_index = CBIndex::c_8;
    const tt::CBIndex output_cb_index = CBIndex::c_5;
