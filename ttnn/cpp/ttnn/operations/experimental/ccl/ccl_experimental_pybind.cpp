...
#include "ttnn/operations/experimental/ccl/llama_prefill_reduce_scatter/llama_prefill_reduce_scatter_pybind.hpp"
...
void py_module(pybind11::module& module) {
    ...
    ccl::py_bind_llama_prefill_reduce_scatter(module);
}
