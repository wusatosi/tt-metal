...
#include "all_gather_legacy_pybind.hpp"

#include <pybind11/pybind11.h>
#include <pybind11/stl.h>

#include "ttnn-pybind/decorators.hpp"
#include "ttnn/operations/experimental/ccl/all_gather_legacy/all_gather_legacy.hpp"
...
void bind_all_gather_legacy(pybind11::module& module, const ccl_operation_t& operation, const char* doc) {
...
void py_bind_all_gather_legacy(pybind11::module& module) {
    detail::bind_all_gather_legacy(
        module,
