...
#include "llama_prefill_reduce_scatter_pybind.hpp"
#include "llama_prefill_reduce_scatter.hpp"
#include <tt-metalium/sub_device_types.hpp>
namespace ttnn::operations::experimental::ccl {
namespace py = pybind11;

void py_bind_llama_prefill_reduce_scatter(py::module& module) {
    auto doc =
        R"doc(llama_prefill_reduce_scatter(input_tensor: ttnn.Tensor, dims: List[int], memory_config: Optional[MemoryConfig] = std::nullopt, queue_id: int = 0) -> ttnn.Tensor
           ...
           Returns:
            ...
            Example:
                ...
                >>> tensor = ttnn.experimental.llama_prefill_reduce_scatter(
    ...
    using OperationType = decltype(ttnn::experimental::llama_prefill_reduce_scatter);
    ttnn::bind_registered_operation(
        module,
        ttnn::experimental::llama_prefill_reduce_scatter,
        doc,
