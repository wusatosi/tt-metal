...
void kernel_main() {
    ...
    // }
        ...
        //         const uint64_t output_noc_address = get_noc_addr(core_x, core_y, base_input_tensor_addr +
        //         tile_offset); const uint32_t receiver_l1_address = base_receiver_l1_addresses + i * page_size_bytes;
