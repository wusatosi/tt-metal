...
LlamaPrefillReduceScatterDeviceOperation::program_factory_t
LlamaPrefillReduceScatterDeviceOperation::select_program_factory(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    return LlamaPrefillReduceScatterAdd{};
}

void LlamaPrefillReduceScatterDeviceOperation::validate_on_program_cache_miss(
    ...
    //     TT_FATAL(
    //         attributes.output_mem_config.value().shard_spec().has_value(), "output_mem_config must have a shard
    //         spec");
    //     TT_FATAL(
...
void LlamaPrefillReduceScatterDeviceOperation::validate_on_program_cache_hit(
    const operation_attributes_t& attributes, const tensor_args_t& tensor_args) {}

LlamaPrefillReduceScatterDeviceOperation::spec_return_value_t
LlamaPrefillReduceScatterDeviceOperation::compute_output_specs(
    const operation_attributes_t& attributes, const tensor_args_t& tensor_args) {
...
LlamaPrefillReduceScatterDeviceOperation::tensor_return_value_t
LlamaPrefillReduceScatterDeviceOperation::create_output_tensors(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
...
std::tuple<
    LlamaPrefillReduceScatterDeviceOperation::operation_attributes_t,
    LlamaPrefillReduceScatterDeviceOperation::tensor_args_t>
LlamaPrefillReduceScatterDeviceOperation::invoke(
    ...
    return {
        ...
        tensor_args_t{
            ...
            // .intermediate_packet_buffer = intermediate_packet_buffer
        }};
}
