...
#include "all_gather_silu_pybind.hpp"

#include <pybind11/pybind11.h>
#include <pybind11/stl.h>

#include "cpp/pybind11/decorators.hpp"
#include "ttnn/operations/experimental/ccl/all_gather_silu/all_gather_silu.hpp"
...
void bind_all_gather_silu(pybind11::module& module, const ccl_operation_t& operation, const char* doc) {
...
void py_bind_all_gather_silu(pybind11::module& module) {
    detail::bind_all_gather_silu(
        module,
        ttnn::experimental::all_gather_silu,
        R"doc(
