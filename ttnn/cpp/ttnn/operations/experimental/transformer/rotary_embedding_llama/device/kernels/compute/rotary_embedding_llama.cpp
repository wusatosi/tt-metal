...
#if RELOAD_IMPL == 0
        ckernel::cb_wait_front(sin_cb, my_cos_sin_tiles);
        ckernel::cb_wait_front(cos_cb, my_cos_sin_tiles);
#endif
...
#if RELOAD_IMPL == 1
                ckernel::cb_wait_front(sin_cb, Wt);
                ckernel::cb_wait_front(cos_cb, Wt);
#endif
...
#if RELOAD_IMPL == 0
        ckernel::cb_pop_front(sin_cb, my_cos_sin_tiles);
        ckernel::cb_pop_front(cos_cb, my_cos_sin_tiles);
#endif
    }
