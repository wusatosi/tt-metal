...
void kernel_main() {
    ...
    ckernel::cb_wait_front(untilized_sin_cb_id, Wt);
    ckernel::cb_reserve_back(untilized_sin_sync_cb_id, Wt);
    ...
    ckernel::cb_push_back(untilized_sin_sync_cb_id, Wt);

    ckernel::cb_wait_front(untilized_cos_cb_id, Wt);
    ckernel::cb_reserve_back(untilized_cos_sync_cb_id, Wt);
    ...
    noc_async_read_barrier();
    ckernel::cb_push_back(untilized_cos_sync_cb_id, Wt);
#endif
