...
tt::tt_metal::operation::ProgramWithCallbacks plusone_single_core_tmp(
    ...
    tt::tt_metal::KernelHandle reader_kernel_id = tt::tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/sdxl_group_norm/device/kernels/reader_plusone_interleaved_tmp.cpp",
        all_cores,
