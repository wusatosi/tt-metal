...
#include "test_op_device_operation.hpp"
...
TestOpDeviceOperation::program_factory_t TestOpDeviceOperation::select_program_factory(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
    return program::TestOpProgramFactory{};
}

void TestOpDeviceOperation::validate_on_program_cache_hit(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
    validate_on_program_cache_miss(args, tensor_args);
}

void TestOpDeviceOperation::validate_on_program_cache_miss(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
...
spec_return_value_t TestOpDeviceOperation::compute_output_specs(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
...
tensor_return_value_t TestOpDeviceOperation::create_output_tensors(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
    if (tensor_args.preallocated_input_grad.has_value()) {
...
tt::stl::hash::hash_t TestOpDeviceOperation::compute_program_hash(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
    const auto& input_tensor = tensor_args.input;
    ...
    operation::Hash hash = operation::hash_operation<TestOpDeviceOperation>(
        args,
...
std::tuple<TestOpDeviceOperation::operation_attributes_t, TestOpDeviceOperation::tensor_args_t>
TestOpDeviceOperation::invoke(
