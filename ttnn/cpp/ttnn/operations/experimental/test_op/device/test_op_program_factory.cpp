...
TestOpProgramFactory::cached_program_t TestOpProgramFactory::create(
    ...
    auto compute_kernel_id = tt::tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/test_op/device/kernels/compute/eltwise_test_op.cpp",
        all_cores,
...
void TestOpProgramFactory::override_runtime_arguments(
    ...
    auto& test_op_reader_kernel_id = shared_vars.test_op_reader_kernel_id;
    auto& test_op_compute_kernel_id = shared_vars.test_op_compute_kernel_id;
    auto& test_op_writer_kernel_id = shared_vars.test_op_writer_kernel_id;
    ...
    auto& reader_runtime_args = GetRuntimeArgs(program, test_op_reader_kernel_id);
    auto& compute_runtime_args = GetRuntimeArgs(program, test_op_compute_kernel_id);
    auto& writer_runtime_args = GetRuntimeArgs(program, test_op_writer_kernel_id);
