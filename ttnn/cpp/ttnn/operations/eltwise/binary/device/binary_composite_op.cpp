...
Tensor ExecuteMaximum::invoke(
    ...
    Tensor eq_m_inf = ttnn::experimental::sub(input_b, input_a);
    ...
    // Tensor logical_and_res = ttnn::experimental::logical_and(t_diff, logical_or_res, std::nullopt,
    // output_mem_config); std::cout << "logical_and_res = " << std::endl; logical_and_res.print(); std::cout <<
    // std::endl;
