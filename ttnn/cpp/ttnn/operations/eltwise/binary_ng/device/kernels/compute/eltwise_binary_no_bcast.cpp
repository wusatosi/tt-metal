...
void MAIN {
    ...
    for (uint32_t tile_id = 0; tile_id < num_tiles; ++tile_id) {
        ...
        ckernel::cb_wait_front(cb_post_lhs, num_tiles_per_cycle);

        PREPROCESS(RHS, cb_pre_rhs, cb_post_rhs, cb_out, num_tiles_per_cycle);
        ckernel::cb_wait_front(cb_post_rhs, num_tiles_per_cycle);
        ...
        ckernel::cb_pop_front(cb_post_lhs, num_tiles_per_cycle);
        ckernel::cb_pop_front(cb_post_rhs, num_tiles_per_cycle);
    }
}
}  // namespace NAMESPACE
