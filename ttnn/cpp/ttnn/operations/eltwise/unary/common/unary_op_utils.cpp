...
std::pair<string, string> get_op_init_and_func_default(UnaryOpType op_type, std::string idst) {
    ...
    switch (op_type) {
        ...
        case UnaryOpType::NEZ_INT32:
            op_init_and_name = {"nez_int_tile_init();", fmt::format("nez_int_tile({});", idst)};
            break;
        ...
        case UnaryOpType::LEZ_INT32:
            op_init_and_name = {"lez_int_tile_init();", fmt::format("lez_int_tile({});", idst)};
            break;
        case UnaryOpType::GEZ: op_init_and_name = {"gez_tile_init();", fmt::format("gez_tile({});", idst)}; break;
        case UnaryOpType::GEZ_INT32:
            op_init_and_name = {"gez_int_tile_init();", fmt::format("gez_int_tile({});", idst)};
            break;
