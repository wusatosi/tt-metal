...
void kernel_main() {
    ...
    const tt_l1_ptr uint32_t* in0_mcast_sender_noc_x = (const tt_l1_ptr uint32_t*)(get_arg_addr(2));
    const tt_l1_ptr uint32_t* in0_mcast_sender_noc_y = (const tt_l1_ptr uint32_t*)(get_arg_addr(2 + num_storage_cores));
