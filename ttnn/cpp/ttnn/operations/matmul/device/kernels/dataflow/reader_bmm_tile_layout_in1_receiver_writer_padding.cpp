...
void kernel_main() {
    ...
    // #ifndef OUT_SHARDED
    //                 // WRITER
    //                 uint32_t num_blocks_h_dim_ = bh >= last_num_blocks_h_dim - 1 ? last_num_blocks_h_dim :
    //                 num_blocks_h_dim; uint32_t num_blocks_w_dim_ = bw >= last_num_blocks_w_dim - 1 ?
    //                 last_num_blocks_w_dim : num_blocks_w_dim; uint32_t out_num_nonzero_subblocks_h_ =
    //                 out_num_nonzero_subblocks_h; uint32_t out_num_nonzero_subblocks_w_ = out_num_nonzero_subblocks_w;
