...
void kernel_main() {
    ...
    //                                 noc_async_read(noc_shard_read_addr, l1_write_extract_shard_in0,
    //                                 shard_read_width);
    ...
    //                                 // Note: noc_async_write_multicast[_loopback_src] may hang if called with 0
    //                                 cores. if constexpr (in0_mcast_num_cores > 1) {
    ...
    //                         id and
    //                         // same vc even though cmd bufs are different Also, this only works because we are
    //                         setting VCs
