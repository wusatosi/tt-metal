                ...
                for (uint32_t block = 0; block < num_blocks_inner_dim; ++block) {
                    ...
                    if (block_id == sender_id) {
                        ...
                        if constexpr (core_in_in0_receiver_mcast_grid) {
                            ...
                            //                                 // On Blackhole the flush is needed because NoC latency
                            //                                 is higher than L1 <-> RISCV latency
                    ...
                    // #ifdef ARCH_BLACKHOLE
                    //                     // On Blackhole the flush is needed because NoC latency is higher than L1 <->
                    //                     RISCV latency
                    //                     // which means data could be changed before
                    //                     //  write is issued.
                    //                     noc_async_writes_flushed();
