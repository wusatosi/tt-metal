...
void py_module(py::module& module) {
    ...
    matmul_multi_core_reuse_multicast_1d_program_config
        .def(
            ...
            py::arg("num_reducer_partials").noconvert() = 1,
            py::arg("n_chunks").noconvert() = 1)
        .def_readwrite(
            "compute_with_storage_grid_size",
        ...
        .def_readwrite("num_reducer_partials", &MatmulMultiCoreReuseMultiCast1DProgramConfig::num_reducer_partials)
        .def_readwrite("n_chunks", &MatmulMultiCoreReuseMultiCast1DProgramConfig::n_chunks);
