...
Tensor Pool2DOp<pool_type>::invoke(
    ...
    if (!out_memory_config.shard_spec.has_value()) {
        ...
        input_tensor_sharded = operation::run(
                           data_movement::InterleavedToShardedDeviceOperation{
                               .output_mem_config = sharded_mem_config,
                               .output_dtype = input_tensor_sharded.get_dtype(),
    ...
    uint32_t output_shard_width_padded = tt::round_up(channels / num_cores_c, tt::constants::TILE_WIDTH);
