...
void kernel_main() {
    ...
    constexpr uint32_t in_cb_nsticks = get_compile_time_arg_val(6);

    constexpr uint32_t in_c = get_compile_time_arg_val(7);

    constexpr uint32_t split_reader = get_compile_time_arg_val(9);
    constexpr uint32_t reader_id = get_compile_time_arg_val(10);
