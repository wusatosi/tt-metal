...
void MAIN {
    ...
    constexpr uint32_t num_output_tiles = in_ntiles_c;
    ...
    pack_untilize_dst_init_short<max_tiles_per_iter>(interm_reduction_cb_id, num_out_rows, num_faces_in_output_tile);
