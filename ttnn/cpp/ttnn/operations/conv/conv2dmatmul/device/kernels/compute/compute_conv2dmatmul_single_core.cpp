...
void MAIN {
    ...
    constexpr uint32_t per_core_block_tile_cnt = get_compile_time_arg_val(2);

    uint32_t per_core_block_cnt_ = get_arg_val<uint32_t>(0);

    constexpr uint32_t per_core_block_cnt = per_core_block_cnt;
    constexpr uint32_t per_core_block_tile_cnt = per_core_block_tile_cnt;
