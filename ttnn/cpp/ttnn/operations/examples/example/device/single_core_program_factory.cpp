...
ExampleDeviceOperation::SingleCore::cached_program_t ExampleDeviceOperation::SingleCore::create(
    ...
    auto block_size = operation_attributes.block_size;
    ...
    log_info(
        LogTest,
        "num_tiles {}, num_tiles_per_core_group_1 {}, num_tiles_per_core_group_2 {}, block_size {}",
        num_tiles,
    ...
    std::vector<uint32_t> reader_compile_time_args = {(uint32_t)src_is_dram, block_size};
    bool dst_is_dram = dst_buffer->buffer_type() == tt::tt_metal::BufferType::DRAM ? 1 : 0;
    std::vector<uint32_t> writer_compile_time_args = {
        (std::uint32_t)output_cb_index, (std::uint32_t)dst_is_dram, block_size};
