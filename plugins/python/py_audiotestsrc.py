...
OCAPS = Gst.Caps.from_string("audio/x-raw, format=F32LE, layout=interleaved, rate=44100, channels=2")
...
class AudioTestSrc(GstBase.BaseSrc):
    ...
    __gproperties__ = {
        ...
        "is-live": (bool, "Is live", "Whether to act as a live source", DEFAULT_IS_LIVE, GObject.ParamFlags.READWRITE),
    }
