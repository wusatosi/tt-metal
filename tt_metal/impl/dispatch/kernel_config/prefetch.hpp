...
//
// Represents a cq_prefetch kernel
//
// Upstream kernels: Prefetcher will increment semaphores on the upstream to indicate it has pages free
// Downstream kernels: Prefetcher will wait on semaphores on the downstream and send data to it. A fabric mux can be
// specified
