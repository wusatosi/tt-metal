...
const std::unordered_set<uint8_t> &CircularBufferConfig::local_buffer_indices() const { return this->local_buffer_indices_; }
const std::unordered_set<uint8_t> &CircularBufferConfig::remote_buffer_indices() const { return this->remote_buffer_indices_; }
...
CircularBufferConfig::Builder CircularBufferConfig::Builder::LocalBuilder(CircularBufferConfig &parent, uint8_t buffer_index) {
...
CircularBufferConfig::Builder CircularBufferConfig::Builder::RemoteBuilder(CircularBufferConfig &parent, uint8_t buffer_index) {
...
CircularBufferConfig::Builder CircularBufferConfig::index(uint8_t buffer_index) { return Builder::LocalBuilder(*this, buffer_index); }

CircularBufferConfig::Builder CircularBufferConfig::remote_index(uint8_t buffer_index) { return Builder::RemoteBuilder(*this, buffer_index); }
