...
class Cluster {
   public:
    ...
    void deassert_risc_reset_at_core(const tt_cxy_pair &core, const TensixSoftResetOptions &soft_resets = TENSIX_DEASSERT_SOFT_RESET) const;
    void assert_risc_reset_at_core(const tt_cxy_pair &core, const TensixSoftResetOptions &soft_resets = TENSIX_ASSERT_SOFT_RESET) const;
