...
// clang-format off
  ...
  */
// clang-format on
ALWI void lez_int_tile(uint32_t idst) { MATH((llk_math_eltwise_unary_sfpu_lez_int<APPROX>(idst))); }

/**
 * Please refer to documentation for any_init.
 */
ALWI void lez_int_tile_init() { MATH((llk_math_eltwise_unary_sfpu_lez_int_init<APPROX>())); }
...
// clang-format off
  ...
  */
// clang-format on
ALWI void gez_int_tile(uint32_t idst) { MATH((llk_math_eltwise_unary_sfpu_gez_int<APPROX>(idst))); }

/**
 * Please refer to documentation for any_init.
 */
ALWI void gez_int_tile_init() { MATH((llk_math_eltwise_unary_sfpu_gez_int_init<APPROX>())); }
...
// clang-format off
  ...
  */
// clang-format on
ALWI void nez_int_tile(uint32_t idst) { MATH((llk_math_eltwise_unary_sfpu_nez_int<APPROX>(idst))); }

/**
 * Please refer to documentation for any_init.
 */
ALWI void nez_int_tile_init() { MATH((llk_math_eltwise_unary_sfpu_nez_int_init<APPROX>())); }
}  // namespace ckernel
