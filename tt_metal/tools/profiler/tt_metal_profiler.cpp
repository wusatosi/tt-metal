...
void setControlBuffer(Device *device, std::vector<uint32_t>& control_buffer)
{
#if defined(TRACY_ENABLE)
    ...
    {
        profiler_msg_t *profiler_msg = device->get_dev_addr<profiler_msg_t *>(core.first, HalL1MemAddrType::PROFILER);
