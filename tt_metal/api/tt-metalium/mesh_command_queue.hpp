...
class ProgramCommandsDispatcher {
public:
    ProgramCommandsDispatcher(ThreadPool& thread_pool, MeshDevice* device);
    void enqueue(
...
private:
    ...
    ThreadPool thread_pool_;
    ProgramCommandsDispatcher program_commands_dispatcher_;
