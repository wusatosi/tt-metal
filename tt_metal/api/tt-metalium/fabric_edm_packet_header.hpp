...
// inline uint64_t edm_safe_get_noc_addr(uint8_t dest_noc_x, uint8_t dest_noc_y, uint32_t dest_bank_addr, uint8_t
// noc_id) {
...
//     static constexpr uint8_t LAST_CHIP_IN_MCAST_VAL = 1 <<
//     tt::tt_fabric::RoutingFields::START_DISTANCE_FIELD_BIT_WIDTH; static constexpr uint8_t HOP_DISTANCE_MASK = (1 <<
//     tt::tt_fabric::RoutingFields::RANGE_HOPS_FIELD_BIT_WIDTH) - 1; static constexpr uint8_t RANGE_MASK = ((1 <<
//     tt::tt_fabric::RoutingFields::RANGE_HOPS_FIELD_BIT_WIDTH) - 1)
...
// };
// static_assert(
//     sizeof(MulticastRoutingCommandHeader) <= sizeof(RoutingFields), "MulticastRoutingCommandHeader size is not 1
//     byte");
...
//         modified_command_header.noc_address = noc_addr;
//         modified_command_header.value = noc_unicast_command_header.value;
...
//         modified_command_header.noc_address = noc_addr;
//         modified_command_header.val = noc_unicast_atomic_inc_command_header.val;
//         modified_command_header.wrap = noc_unicast_atomic_inc_command_header.wrap;
...
//         { this->noc_send_type = NOC_MULTICAST_ATOMIC_INC; this->command_fields.mcast_seminc =
//         noc_multicast_atomic_inc_command_header; this->payload_size_bytes = payload_size_bytes; return
...
//         // First line will do 0xAAAAAAAA & 0b1111 = 0b1010. This means starting from our neighbor, we will forward
//         twice
//         // (forward to neighbor is not encoded in the field) Last line will do 0b01 << 4 = 0b010000. This means that
//         on
...
//                (LowLatencyRoutingFields::WRITE_ONLY << (distance_in_hops - 1) *
...
//         =
//         // 0b110000. This means starting from the 3rd chip, we will write and forward once Last line will do 0b01 <<
//         6 =
