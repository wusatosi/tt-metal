    ...
    while (1) {
...

        {
            ...
            if (enables & DISPATCH_CLASS_MASK_TENSIX_ENABLE_DM0) {
                ...
                setup_local_cb_read_write_interfaces(cb_l1_base, num_cbs_to_early_init, end_cb_index, true, true, false);
                ...
                setup_remote_cb_interfaces<true>(cb_l1_base, end_cb_index);
