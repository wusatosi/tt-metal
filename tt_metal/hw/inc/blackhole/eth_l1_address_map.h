...
struct address_map {
    ...
    static constexpr std::int32_t LAUNCH_ERISC_APP_FLAG =
        (ERISC_L1_KERNEL_CONFIG_BASE + ERISC_L1_KERNEL_CONFIG_SIZE + 63) &
        ~63;  // don't need this - just to get things to compile
