...
#if defined(ARCH_BLACKHOLE) && defined(ENABLE_L1_DATA_CACHE)
    asm("fence");
#endif
}

// Enables Blackhole's L1 cache. Grayskull and Wormhole do not have L1 cache
// It is default disabled but L1 cache can be enabled by setting `TT_METAL_ENABLE_L1_DATA_CACHE` env var
