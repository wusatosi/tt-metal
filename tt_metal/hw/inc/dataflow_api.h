...
std::uint64_t get_noc_multicast_addr(
    ...
    */
    // return NOC_MULTICAST_ADDR(DYNAMIC_NOC_X(noc, noc_x_start), DYNAMIC_NOC_Y(noc, noc_y_start), DYNAMIC_NOC_Y(noc, noc_x_end), DYNAMIC_NOC_Y(noc, noc_y_end), addr);
    return NOC_MULTICAST_ADDR(TRANSLATED_DYNAMIC_NOC_X(noc, noc_x_start), TRANSLATED_DYNAMIC_NOC_Y(noc, noc_y_start), TRANSLATED_DYNAMIC_NOC_X(noc, noc_x_end), TRANSLATED_DYNAMIC_NOC_Y(noc, noc_y_end), addr);
}
