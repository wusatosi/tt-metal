...
#define RD_RESP_RECEIVED 0
#define NONPOSTED_WR_REQ_SENT 1
#define NONPOSTED_WR_ACK_RECEIVED 2
#define NONPOSTED_ATOMIC_RESP_RECEIVED 3
#define POSTED_WR_REQ_SENT 4

#define BRISC_NOC0_RD_RESP_RECEIVED MEM_NOC_COUNTER_BASE
#define BRISC_NOC0_NONPOSTED_WR_REQ_SENT (BRISC_NOC0_RD_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED (BRISC_NOC0_NONPOSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED (BRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC0_POSTED_WR_REQ_SENT (BRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)

#define BRISC_NOC1_RD_RESP_RECEIVED (BRISC_NOC0_POSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC1_NONPOSTED_WR_REQ_SENT (BRISC_NOC1_RD_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED (BRISC_NOC1_NONPOSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED (BRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define BRISC_NOC1_POSTED_WR_REQ_SENT (BRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)

#define NCRISC_NOC0_RD_RESP_RECEIVED (BRISC_NOC1_POSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC0_NONPOSTED_WR_REQ_SENT (NCRISC_NOC0_RD_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED (NCRISC_NOC0_NONPOSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED (NCRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC0_POSTED_WR_REQ_SENT (NCRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)

#define NCRISC_NOC1_RD_RESP_RECEIVED (NCRISC_NOC0_POSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC1_NONPOSTED_WR_REQ_SENT (NCRISC_NOC1_RD_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED (NCRISC_NOC1_NONPOSTED_WR_REQ_SENT + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED (NCRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED + MEM_NOC_COUNTER_SIZE)
#define NCRISC_NOC1_POSTED_WR_REQ_SENT (NCRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED + MEM_NOC_COUNTER_SIZE)

template <uint32_t risc_type, uint32_t counter_type>
inline __attribute__((always_inline)) uint32_t get_noc_counter_address(uint32_t noc) {
    if constexpr (
        risc_type == static_cast<std::underlying_type_t<TensixProcessorTypes>>(TensixProcessorTypes::DM0)) {  // BRISC
        if constexpr (counter_type == RD_RESP_RECEIVED) {
            return noc == 0 ? BRISC_NOC0_RD_RESP_RECEIVED : BRISC_NOC1_RD_RESP_RECEIVED;
        } else if constexpr (counter_type == NONPOSTED_WR_REQ_SENT) {
            return noc == 0 ? BRISC_NOC0_NONPOSTED_WR_REQ_SENT : BRISC_NOC1_NONPOSTED_WR_REQ_SENT;
        } else if constexpr (counter_type == NONPOSTED_WR_ACK_RECEIVED) {
            return noc == 0 ? BRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED : BRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED;
        } else if constexpr (counter_type == NONPOSTED_ATOMIC_RESP_RECEIVED) {
            return noc == 0 ? BRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED : BRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED;
        } else {  // POSTED_WR_REQ_SENT
            return noc == 0 ? BRISC_NOC0_POSTED_WR_REQ_SENT : BRISC_NOC1_POSTED_WR_REQ_SENT;
        }
    } else {
        if constexpr (counter_type == RD_RESP_RECEIVED) {
            return noc == 0 ? NCRISC_NOC0_RD_RESP_RECEIVED : NCRISC_NOC1_RD_RESP_RECEIVED;
        } else if constexpr (counter_type == NONPOSTED_WR_REQ_SENT) {
            return noc == 0 ? NCRISC_NOC0_NONPOSTED_WR_REQ_SENT : NCRISC_NOC1_NONPOSTED_WR_REQ_SENT;
        } else if constexpr (counter_type == NONPOSTED_WR_ACK_RECEIVED) {
            return noc == 0 ? NCRISC_NOC0_NONPOSTED_WR_ACK_RECEIVED : NCRISC_NOC1_NONPOSTED_WR_ACK_RECEIVED;
        } else if constexpr (counter_type == NONPOSTED_ATOMIC_RESP_RECEIVED) {
            return noc == 0 ? NCRISC_NOC0_NONPOSTED_ATOMIC_RESP_RECEIVED : NCRISC_NOC1_NONPOSTED_ATOMIC_RESP_RECEIVED;
        } else {  // POSTED_WR_REQ_SENT
            return noc == 0 ? NCRISC_NOC0_POSTED_WR_REQ_SENT : NCRISC_NOC1_POSTED_WR_REQ_SENT;
        }
    }
}
...
inline __attribute__((always_inline)) uint32_t get_noc_reads_num_issued(uint32_t noc) {
    uint32_t counter_addr = get_noc_counter_address<risc_type, RD_RESP_RECEIVED>(noc);
...
inline __attribute__((always_inline)) volatile uint32_t get_noc_nonposted_writes_num_issued(uint32_t noc) {
    uint32_t counter_addr = get_noc_counter_address<risc_type, NONPOSTED_WR_REQ_SENT>(noc);
    return NOC_READ_REG(counter_addr);
}
...
inline __attribute__((always_inline)) uint32_t get_noc_nonposted_writes_acked(uint32_t noc) {
    uint32_t counter_addr = get_noc_counter_address<risc_type, NONPOSTED_WR_ACK_RECEIVED>(noc);
    return NOC_READ_REG(counter_addr);
}
...
inline __attribute__((always_inline)) uint32_t get_noc_nonposted_atomics_acked(uint32_t noc) {
    uint32_t counter_addr = get_noc_counter_address<risc_type, NONPOSTED_ATOMIC_RESP_RECEIVED>(noc);
    return NOC_READ_REG(counter_addr);
}
...
inline __attribute__((always_inline)) uint32_t get_noc_posted_writes_num_issued(uint32_t noc) {
    uint32_t counter_addr = get_noc_counter_address<risc_type, POSTED_WR_REQ_SENT>(noc);
    return NOC_READ_REG(counter_addr);
}
...
inline __attribute__((always_inline)) bool ncrisc_noc_reads_flushed(uint32_t noc) {
    ...
    return (NOC_STATUS_READ_REG(noc, NIU_MST_RD_RESP_RECEIVED) == get_noc_reads_num_issued<risc_type>(noc));
}
...
inline __attribute__((always_inline)) void ncrisc_noc_fast_write(
    ...
    // }
    if (posted) {
        inc_noc_posted_writes_num_issued<risc_type>(noc);
        // noc_posted_writes_num_issued[noc] += 1;
    } else {
...
inline __attribute__((always_inline)) void ncrisc_noc_blitz_write_setup(
    ...
    inc_noc_nonposted_writes_num_issued<risc_type>(noc, num_times_to_write);
...
inline __attribute__((always_inline)) bool ncrisc_noc_nonposted_writes_sent(uint32_t noc) {
    ...
    return (
        NOC_STATUS_READ_REG(noc, NIU_MST_NONPOSTED_WR_REQ_SENT) == get_noc_nonposted_writes_num_issued<risc_type>(noc));
}
...
inline __attribute__((always_inline)) bool ncrisc_noc_posted_writes_sent(uint32_t noc) {
    ...
    return (NOC_STATUS_READ_REG(noc, NIU_MST_POSTED_WR_REQ_SENT) == get_noc_posted_writes_num_issued<risc_type>(noc));
}
...
inline __attribute__((always_inline)) void noc_local_state_init(int noc) {
    set_noc_reads_num_issued<risc_type>(noc, NOC_STATUS_READ_REG(noc, NIU_MST_RD_RESP_RECEIVED));
...
inline __attribute__((always_inline)) void ncrisc_noc_fast_read_any_len(
    ...
    while (len_bytes > NOC_MAX_BURST_SIZE) {
        while (!noc_cmd_buf_ready(noc, cmd_buf));
        ncrisc_noc_fast_read<risc_type>(noc, cmd_buf, src_addr, dest_addr, NOC_MAX_BURST_SIZE);
        src_addr += NOC_MAX_BURST_SIZE;
        dest_addr += NOC_MAX_BURST_SIZE;
        len_bytes -= NOC_MAX_BURST_SIZE;
    }
    while (!noc_cmd_buf_ready(noc, cmd_buf));
    ncrisc_noc_fast_read<risc_type>(noc, cmd_buf, src_addr, dest_addr, len_bytes);
}
...
inline __attribute__((always_inline)) void ncrisc_noc_fast_write_any_len(
    ...
    while (len_bytes > NOC_MAX_BURST_SIZE) {
        while (!noc_cmd_buf_ready(noc, cmd_buf));
        ncrisc_noc_fast_write<risc_type>(
            noc,
            cmd_buf,
            src_addr,
            dest_addr,
...
inline __attribute__((always_inline)) void ncrisc_noc_fast_write_any_len_loopback_src(
    ...
    while (len_bytes > NOC_MAX_BURST_SIZE) {
        while (!noc_cmd_buf_ready(noc, cmd_buf));
        ncrisc_noc_fast_write_loopback_src<risc_type>(
            noc,
            cmd_buf,
            src_addr,
            dest_addr,
