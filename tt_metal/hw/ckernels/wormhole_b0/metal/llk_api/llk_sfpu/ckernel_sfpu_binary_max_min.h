...
#pragma GCC unroll 0
    for (int d = 0; d < ITERATIONS; d++) {
        ...
        TTI_SFPLOAD(p_sfpu::LREG0, 6, ADDR_MOD_3, 0);                          // a
        TT_SFPLOAD(p_sfpu::LREG1, 6, ADDR_MOD_3, dst_offset * dst_tile_size);  // b
        TTI_SFPIADD(
            0,
            p_sfpu::LREG1,
            p_sfpu::LREG0,
        ...
        // TTI_SFPSWAP(0, p_sfpu::LREG1, p_sfpu::LREG0, 4);
        // TTI_SFPNOP;
        // TTI_SFPSTORE(p_sfpu::LREG1, 6, ADDR_MOD_3, 0);
