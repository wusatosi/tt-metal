...
inline vFloat calculate_pos_cdf_appx(vFloat val) {
    ...
    v_elseif(val <= 4.0f) { result = POLYVAL5(-0.00221732, 0.03261405, -0.18073549, 0.44774828, 0.58105795, val); }
    v_elseif(val <= 5.5f) {
        result = POLYVAL5(-2.63014064e-05, 5.30494095e-04, -4.00997996e-03, 1.34653525e-02, 9.83048834e-01, val);
    }
    v_else {
        // assume v >= 2.5f - 5
        // result = POLYVAL5(-0.00221304f,  0.03253934f, -0.18027954f,  0.44656975f,  0.58216001f, val);
