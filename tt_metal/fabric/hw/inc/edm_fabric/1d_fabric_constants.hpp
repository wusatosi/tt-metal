...
// CHANNEL CONSTANTS
#ifdef FABRIC_2D
constexpr size_t NUM_LINE_SENDER_CHANNELS = 4;
constexpr size_t NUM_RING_SENDER_CHANNELS = 5;
#else
...
constexpr size_t local_sender_3_channel_address = get_compile_time_arg_val(16);
constexpr size_t local_sender_channel_3_connection_info_addr = get_compile_time_arg_val(17);
constexpr size_t local_sender_4_channel_address = get_compile_time_arg_val(18);
constexpr size_t local_sender_channel_4_connection_info_addr = get_compile_time_arg_val(19);
constexpr size_t local_receiver_0_channel_buffer_address = get_compile_time_arg_val(20);
constexpr size_t remote_receiver_0_channel_buffer_address = get_compile_time_arg_val(21);
constexpr size_t local_receiver_1_channel_buffer_address = get_compile_time_arg_val(22);
constexpr size_t remote_receiver_1_channel_buffer_address = get_compile_time_arg_val(23);
constexpr size_t remote_sender_0_channel_address = get_compile_time_arg_val(24);
constexpr size_t remote_sender_1_channel_address = get_compile_time_arg_val(25);
constexpr size_t remote_sender_2_channel_address = get_compile_time_arg_val(26);
constexpr size_t remote_sender_3_channel_address = get_compile_time_arg_val(27);
constexpr size_t remote_sender_4_channel_address = get_compile_time_arg_val(28);

// TODO: CONVERT TO SEMAPHORE
constexpr uint32_t termination_signal_addr = get_compile_time_arg_val(29);
#ifdef WAIT_FOR_HOST_SIGNAL
constexpr uint32_t edm_local_sync_ptr_addr = get_compile_time_arg_val(30);
#endif
constexpr uint32_t edm_status_ptr_addr = get_compile_time_arg_val(31);

constexpr bool persistent_mode = get_compile_time_arg_val(32) != 0;

// Per-channel counters
constexpr bool enable_fabric_counters = get_compile_time_arg_val(33) != 0;
constexpr size_t receiver_channel_0_counters_address = get_compile_time_arg_val(34);
constexpr size_t receiver_channel_1_counters_address = get_compile_time_arg_val(35);
constexpr size_t sender_channel_0_counters_address = get_compile_time_arg_val(36);
constexpr size_t sender_channel_1_counters_address = get_compile_time_arg_val(37);
constexpr size_t sender_channel_2_counters_address = get_compile_time_arg_val(38);
constexpr size_t sender_channel_3_counters_address = get_compile_time_arg_val(39);
constexpr size_t sender_channel_4_counters_address = get_compile_time_arg_val(40);

constexpr bool enable_packet_header_recording = get_compile_time_arg_val(41) != 0;
constexpr size_t receiver_0_completed_packet_header_cb_address = get_compile_time_arg_val(42);
constexpr size_t receiver_0_completed_packet_header_cb_size_headers = get_compile_time_arg_val(43);
constexpr size_t receiver_1_completed_packet_header_cb_address = get_compile_time_arg_val(44);
constexpr size_t receiver_1_completed_packet_header_cb_size_headers = get_compile_time_arg_val(45);
constexpr size_t sender_0_completed_packet_header_cb_address = get_compile_time_arg_val(46);
constexpr size_t sender_0_completed_packet_header_cb_size_headers = get_compile_time_arg_val(47);
constexpr size_t sender_1_completed_packet_header_cb_address = get_compile_time_arg_val(48);
constexpr size_t sender_1_completed_packet_header_cb_size_headers = get_compile_time_arg_val(49);
constexpr size_t sender_2_completed_packet_header_cb_address = get_compile_time_arg_val(50);
constexpr size_t sender_2_completed_packet_header_cb_size_headers = get_compile_time_arg_val(51);
constexpr size_t sender_3_completed_packet_header_cb_address = get_compile_time_arg_val(52);
