...
#ifdef ENABLE_ACTIVE_ERISC_IRAM
constexpr uint32_t FVCC_OUT_BUF_START = eth_l1_mem::address_map::KERNEL_BASE;
#else
...
#ifdef ENABLE_ACTIVE_ERISC_IRAM
static_assert(
    FABRIC_ROUTER_REQ_QUEUE_START + FABRIC_ROUTER_REQ_QUEUE_SIZE <=
    eth_l1_mem::address_map::KERNEL_BASE + eth_l1_mem::address_map::KERNEL_CODE_SIZE);

constexpr uint32_t FABRIC_ROUTER_DATA_BUF_START = FABRIC_ROUTER_MISC_START + FABRIC_ROUTER_MISC_SIZE;
#else
