...
class MeshWorkload : public tt::tt_metal::Workload<MeshDevice*> {
...
private:
    ...
    void generate_dispatch_commands(MeshDevice* mesh_device);
...
public:
    ...
    uint32_t get_sem_base_addr(MeshDevice* mesh_device, CoreCoord logical_core, CoreType core_type);
    uint32_t get_sem_size(MeshDevice* mesh_device, CoreCoord logical_core, CoreType core_type) const;
    uint32_t get_cb_base_addr(MeshDevice* mesh_device, CoreCoord logical_core, CoreType core_type);
    uint32_t get_cb_size(MeshDevice* mesh_device, CoreCoord logical_core, CoreType core_type) const;
};
}  // namespace tt::tt_metal::distributed
