...
void DeviceJitBuild::init(
    chip_id_t id, uint8_t num_hw_cqs, tt::ARCH arch, const std::map<std::string, std::string>& device_kernel_defines) {
    log_info(tt::LogAlways, "DeviceJitBuild init called");
    ...
    auto init_helper = [this, arch, dispatch_message_addr, num_build_states](bool is_fw) -> JitBuildStateSet {
                ...
                for (uint32_t processor_type = 0; processor_type < processor_types_count; processor_type++) {
                    switch (core_type) {
                        ...
                        case HalProgrammableCoreType::ACTIVE_ETH: {
                            ...
                            bool is_cooperative = arch == ARCH::WORMHOLE_B0;
