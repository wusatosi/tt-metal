...
def test_sum(device, h, w, c, n, dim, input_dtype, core_num):
    torch.manual_seed(0)
...
@pytest.mark.parametrize("input_dtype", [ttnn.float32, ttnn.bfloat16, ttnn.bfloat8_b])
@pytest.mark.parametrize("core_num", [2, 4, 8, 16, 32, 64])
def test_max(device, h, w, c, n, dim, input_dtype, core_num):
    torch.manual_seed(0)
...
@pytest.mark.parametrize("input_dtype", [ttnn.float32, ttnn.bfloat16, ttnn.bfloat8_b])
@pytest.mark.parametrize("core_num", [2, 4, 8, 16, 32, 64])
def test_mean(device, h, w, c, n, dim, input_dtype, core_num):
    torch.manual_seed(0)
...
@pytest.mark.parametrize("dim", [-2])
@pytest.mark.parametrize("input_dtype", [ttnn.float32, ttnn.bfloat16, ttnn.bfloat8_b])
def test_sum_uneven(device, h, w, c, n, dim, input_dtype):
    torch.manual_seed(0)
