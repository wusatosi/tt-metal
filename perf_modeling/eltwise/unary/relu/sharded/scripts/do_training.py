...
output_file = "perf_modeling/eltwise/unary/relu/sharded/csvs/filtered_rows_sharded.csv"
aggregated_file = "perf_modeling/eltwise/unary/relu/sharded/csvs/aggregated_values_sharded.csv"
fitting_file = "perf_modeling/eltwise/unary/relu/sharded/csvs/fitting_data_sharded.csv"  # New file for fitting data
image_file = "perf_modeling/eltwise/unary/relu/sharded/plots/fitting_plot_sharded.png"
...
with open(fitting_file, mode="w", newline="") as fit_file:
    ...
    fig, axes = plt.subplots(nrows=2, ncols=3, figsize=(20, 15))  # 4 rows and 3 columns
    axes = axes.flatten()
    plot_count = 0
